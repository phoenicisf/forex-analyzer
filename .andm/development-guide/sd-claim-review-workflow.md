...
│  (ใช้ prompt: .andm/prompt-templates/system-design-master-*.md)    │
└──────────────────────┬───────────────────────────────────────────────┘
                       ▼
┌──────────────────────────────────────────────────────────────────────┐
...
>
> ดู: `.agents/skills/andm-impl-planner/SKILL.md § Vertical Slicing Strategy` + `.agents/workflows/impl-plan.md` สำหรับรายละเอียดการแบ่ง Implementation Phases และ SD hint honor/override protocol *(narrative impl-workflow guide retired in 2026-05-07 cleanup)*
...
- `.andm/prompt-templates/system-design-master-prompt.md`

...
|-------|-------------|-------------------|-------------|
| `ba` | `docs/ba/01-05` (5 files; v1.2: 06-handoff dropped) | `.andm/prompt-templates/ba-requirements-prompt.md` | `docs/ba/claim-review-and-rebuttal/` |
| `sd` | `docs/design-docs/02-08` (6 files; v1.2: gaps ที่ 01/06 — merged into 02) + `docs/adr/` + `docs/api-specs/` | `.andm/prompt-templates/system-design-master-prompt.md` | `docs/design-docs/claim-review-and-rebuttal/` |
| `ux` | `docs/ux/01-05` (5 files; UX-06 dropped per SD-as-Master) | `.andm/development-guide/ux-design-workflow.md` | Stakeholder approve |
| `td` | `docs/technical-design/02,03,04` + `docs/api-specs/` + `docs/adr/` + `docs/qa/01-test-execution-plan.md` | `.andm/prompt-templates/technical-design-master-prompt.md` | `docs/technical-design/claim-review-and-rebuttal/` |
...
| **Can read** | ทุกไฟล์ใน `docs/`, `.claude/rules/`, `.andm/prompt-templates/` |

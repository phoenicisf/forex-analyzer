...
**To Phase 1 BA:**
- BA prompt (`.andm/prompt-templates/ba-requirements-prompt.md`) จะอ่าน `docs/foundation-input-sources/ideation-brief.md` อัตโนมัติผ่าน existing input-sources convention

...
│  (ใช้ prompt: .agents/prompt-templates/ba-requirements-*.md) │
└──────────────────────┬──────────────────────────────────────┘
                       ▼
┌──────────────────────────────────────────────────────────────┐
...
- `.agents/prompt-templates/ba-requirements-prompt.md`
...
- รัน `/sd` (workflow wraps `.agents/prompt-templates/system-design-master-prompt.md`) — agent โหลด BA + foundation-input-sources อัตโนมัติ

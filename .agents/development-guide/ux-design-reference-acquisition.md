...
- `methodologies/full-track/.agents/workflows/ux-design.md § Mode D` — workflow ที่บริโภคไฟล์จาก `design-reference/`
- `methodologies/full-track/.agents/prompt-templates/ux-design-reference-prompt.md` — prompt ที่ AI agent ใช้
- `methodologies/full-track/.agents/development-guide/ux-design-workflow.md` — full UX workflow journey (Step 1 + Step 2)

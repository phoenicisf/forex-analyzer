...
| **Development guide** | `.agents/development-guide/ideate-workflow.md` (full walkthrough + example brief) |
| **Output file** | `docs/foundation-input-sources/ideation-brief.md` |

> **Output consumption:** `/ba` workflow (wraps `.agents/prompt-templates/ba-requirements-prompt.md`) อ่าน `docs/foundation-input-sources/` อัตโนมัติ — ไม่ต้อง manual handoff ไป Phase 1
...
**Workflow:** `.agents/workflows/ba.md` (wraps `.agents/prompt-templates/ba-requirements-prompt.md` + adds Phase 0 onboarding + Phase 3 quality gate enforcement)
...
**Workflow:** `.agents/workflows/sd.md` (wraps `.agents/prompt-templates/system-design-master-prompt.md` + adds Phase 0 onboarding + Phase 3 quality gate including schedule-leakage check)
...
**Workflow:** `.agents/workflows/td.md` (wraps `.agents/prompt-templates/technical-design-master-prompt.md` + adds Phase 0 onboarding + Phase 3 quality gate including SD-as-Master scope contract + cross-domain consistency check)
...
**📖 Guide:** `.agents/development-guide/ba-claim-review-workflow.md`
...
**📖 Guide:** `.agents/development-guide/sd-claim-review-workflow.md`
...
**📖 Guide:** `.agents/development-guide/ux-design-workflow.md` → Step 3
...
**📖 Guide:** `.agents/development-guide/project-init-workflow.md`
...
- **L-XL** → per-layer decomposition with HALT per step *(exception path only — default is Planner decomposing into `[slice]` sub-tasks; see `impl-workflow.md` §Auto-Detect Size and `andm-impl-planner/SKILL.md § Vertical Slicing Strategy`)*

**📖 Guide:** `.agents/development-guide/impl-workflow.md`
...
**📖 Guide:** `.agents/development-guide/qa-plan-workflow.md` § 3T
...
**📖 Guide:** `.agents/development-guide/red-team-workflow.md`
...
```
.agents/                                    ← ROOT ASSEMBLED (source of truth for IDE adapters)
  workflows/                                ← 30 workflows (22 full-track + 7 lean-track + manifest)
  skills/                                   ← 69 skills (46 full-track + 21 lean-track + 2 shared)
  agents/                                   ← 11 Claude Code subagents (full-track)

methodologies/full-track/
  .agents/                                  ← FULL-TRACK SOURCE (assembled to root .agents/ via scripts/assemble-agents.sh)
    ...
    prompt-templates/                       ← Authoritative prompt content (consumed by workflows; can also be copy-pasted)
...
.agents/development-guide/
  ...
  impl-workflow.md                  ← Implementation guide
  impl-review-workflow.md           ← Code review guide
  qa-plan-workflow.md               ← QA planning guide (parallel with impl)
  red-team-workflow.md              ← Security audit guide
...
**📖 Guide:** `.agents/development-guide/amend-workflow.md`

...
- Source: `.agents/workflows/next.md`
- Runtime headings: 32
- Heading coverage: 100.00%
- Command coverage: 100.00%
- Phrase coverage: 100.00%
- Compression ratio: 59.80%
...
Next Action: ใช้ prompt template สร้าง QA docs
  ...
  → ดู `.andm/development-guide/qa-plan-workflow.md`

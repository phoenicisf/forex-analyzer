...
**Generated:** 2026-05-11T05:44:21+00:00
**Script:** `simulation/scripts/journal_diff.py`
**Inputs:**
- Rewrite: `docs\state\_session-handoff\IMPL-FIX-011a-q1_rewrite_postpatch_202605111244.jsonl` (15 events)
...
|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---|---|
| 1 | `G2` | entry | 2 | 0 | +2 | 2 | 2 | 0 | 1 | 0 | **(e) eligibility** | rewrite-only — fires 2 entries in 2 H4 buckets while legacy is silent |
| 2 | `T` | exit | 1 | 3 | -2 | 2 | 1 | 3 | 1 | 1 | **(e) eligibility** | both legs active but count drift |delta|=2 (rewrite=1 vs legacy=3) |
| 3 | `B` | entry | 0 | 1 | -1 | 1 | 0 | 1 | 0 | 1 | **(e) eligibility** | legacy-only — fires 1 entries while rewrite is silent |
| 4 | `B` | exit | 0 | 1 | -1 | 1 | 0 | 1 | 0 | 1 | **(e) eligibility** | legacy-only — fires 1 entries while rewrite is silent |
| 5 | `BR` | entry | 0 | 1 | -1 | 1 | 0 | 1 | 0 | 1 | **(e) eligibility** | legacy-only — fires 1 entries while rewrite is silent |
| 6 | `BR` | exit | 0 | 1 | -1 | 1 | 0 | 1 | 0 | 1 | **(e) eligibility** | legacy-only — fires 1 entries while rewrite is silent |
| 7 | `D` | entry | 0 | 1 | -1 | 1 | 0 | 1 | 0 | 1 | **(e) eligibility** | legacy-only — fires 1 entries while rewrite is silent |
| 8 | `D` | exit | 0 | 1 | -1 | 1 | 0 | 1 | 0 | 1 | **(e) eligibility** | legacy-only — fires 1 entries while rewrite is silent |
| 9 | `G` | entry | 1 | 0 | +1 | 1 | 1 | 0 | 1 | 0 | **(e) eligibility** | rewrite-only — fires 1 entries in 1 H4 buckets while legacy is silent |
| 10 | `H` | entry | 0 | 1 | -1 | 1 | 0 | 1 | 0 | 1 | **(e) eligibility** | legacy-only — fires 1 entries while rewrite is silent |
...
|---|---:|---|
| (e) eligibility | 10 | G2/entry (|Δ|=2), T/exit (|Δ|=2), B/entry (|Δ|=1), B/exit (|Δ|=1), BR/entry (|Δ|=1), BR/exit (|Δ|=1) |

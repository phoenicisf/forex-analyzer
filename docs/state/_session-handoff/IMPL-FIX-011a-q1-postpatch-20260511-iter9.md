...
**Generated:** 2026-05-11T05:16:55+00:00
**Script:** `simulation/scripts/journal_diff.py`
**Inputs:**
- Rewrite: `docs\state\_session-handoff\IMPL-FIX-011a-q1_rewrite_postpatch_202605111216.jsonl` (16 events)
...
| 2 | `T` | entry | 6 | 4 | +2 | 2 | 6 | 4 | 1 | 1 | **(e) eligibility** | both legs active but count drift |delta|=2 (rewrite=6 vs legacy=4) |
| 3 | `T` | exit | 1 | 3 | -2 | 2 | 1 | 3 | 1 | 1 | **(e) eligibility** | both legs active but count drift |delta|=2 (rewrite=1 vs legacy=3) |
...
| 2021-02-04 16:00Z | 1 | 0 | +1 |
| 2021-02-26 04:00Z | 0 | 1 | -1 |
| 2021-03-23 12:00Z | 1 | 0 | +1 |
| 2021-03-25 16:00Z | 1 | 0 | +1 |
...
|---|---:|---|
| (e) eligibility | 10 | G2/entry (|Δ|=2), T/entry (|Δ|=2), T/exit (|Δ|=2), B/entry (|Δ|=1), B/exit (|Δ|=1), BR/entry (|Δ|=1) |

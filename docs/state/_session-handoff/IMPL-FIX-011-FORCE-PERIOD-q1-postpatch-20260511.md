...
**Generated:** 2026-05-11T08:52:59+00:00
**Script:** `simulation/scripts/journal_diff.py`
**Inputs:**
- Rewrite: `docs\state\_session-handoff\IMPL-FIX-011-FORCE-PERIOD-q1_rewrite_postpatch_202605111552.jsonl` (6 events)
...
| 10 | `G2` | entry | 1 | 0 | +1 | 1 | 1 | 0 | 1 | 0 | **(e) eligibility** | rewrite-only — fires 1 entries in 1 H4 buckets while legacy is silent |
...
Distinct entry slots with |Δ| ≥ 1: **10** — `B, BR, D, G2, H, K, M, P, Q, T`

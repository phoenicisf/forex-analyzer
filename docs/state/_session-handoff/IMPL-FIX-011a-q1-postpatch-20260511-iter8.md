...
**Generated:** 2026-05-11T05:09:33+00:00
**Script:** `simulation/scripts/journal_diff.py`
**Inputs:**
- Rewrite: `docs\state\_session-handoff\IMPL-FIX-011a-q1_rewrite_postpatch_202605111209.jsonl` (13 events)
...
| 3 | `T` | pending_force_clear | 3 | 0 | +3 | 3 | 3 | 0 | 1 | 0 | **(e) eligibility** | rewrite-only — fires 3 entries in 3 H4 buckets while legacy is silent |
...
|---|---:|---|
| (e) eligibility | 10 | T/entry (|Δ|=3), T/exit (|Δ|=3), T/pending_force_clear (|Δ|=3), G2/entry (|Δ|=2), B/entry (|Δ|=1), B/exit (|Δ|=1) |

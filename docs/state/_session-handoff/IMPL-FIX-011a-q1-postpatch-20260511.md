...
**Generated:** 2026-05-11T04:28:31+00:00
**Script:** `simulation/scripts/journal_diff.py`
**Inputs:**
- Rewrite: `docs\state\_session-handoff\IMPL-FIX-011a-q1_rewrite_postpatch_202605111128.jsonl` (9 events)
...
|---:|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---|---|
| 1 | `T` | entry | 0 | 4 | -4 | 4 | 0 | 4 | 0 | 1 | **(e) eligibility** | legacy-only — fires 4 entries while rewrite is silent |
...
|---|---:|---|
| (e) eligibility | 10 | T/entry (|Δ|=4), T/exit (|Δ|=3), G2/entry (|Δ|=2), B/entry (|Δ|=1), B/exit (|Δ|=1), BR/entry (|Δ|=1) |

...
> **End of 05 — Security** — STRIDE 6 categories, defensive controls inventory (boot-time + runtime + failure-mode), operational risks (non-AppSec), observability strategy, no-AuthN/AuthZ + no-encryption rationale, Red Team hand-off

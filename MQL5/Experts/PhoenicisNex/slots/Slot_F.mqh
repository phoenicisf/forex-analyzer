...
//|                                                                   |
//| Activation: Phase-2 wiring; see docs/state/deferred-ac-registry.md (CrossSlotCoordinator wires CD-open →       |
...
public:
   ...
   //       early-return guard in Phase 1 MVP (real activation Phase-2 wiring; see docs/state/deferred-ac-registry.md)
...
//| not from main OnTick topo. The body early-returns until Phase-2 wiring; see docs/state/deferred-ac-registry.md |
...
void CSlotF::Evaluate(const MarketContext &ctx, CPortfolioState &port)
  {
   ...
   //    (Phase 1 MVP — real signal arrives via OpenOrderCD chain at Phase-2 wiring; see docs/state/deferred-ac-registry.md)
   ...
   //    OpenOrderCD (CD-chain) sub-call wires at Phase-2 wiring; see docs/state/deferred-ac-registry.md
   ...
   if(m_xslot != NULL && false /* enable when OpenOrderCD chain wired (Phase-2 wiring; see docs/state/deferred-ac-registry.md) */)
     {

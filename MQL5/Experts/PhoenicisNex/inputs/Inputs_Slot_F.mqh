//+------------------------------------------------------------------+
//| Inputs_Slot_F.mqh โ€” Slot F input parameters (IMPL-021)           |
...
//|     CD entry opens (CodeWiki ยง5.3 :14185 โ€” "chains BusinessLogic_F |
...
//|     reduction (CodeWiki ยง5.3 :15620 dispatcher table)             |
//|                                                                   |
...
//|   โ’ BusinessLogic_F sub-call). Phase 1 Evaluate early-returns.    |
//+------------------------------------------------------------------+
...
input double InpFLotReductionRatio = 0.7;     // Per-slot lot reduction vs CD parent (CodeWiki ยง5.3 OpenOrder "F" flag tier)

...
**📖 Guide:** `methodologies/full-track/constitution/hooks-setup.md`
...
**ใครทำ:** BA Agent
**Prompt:** `.agents/prompt-templates/ba-requirements-prompt.md`
...
**Prompt:** `.agents/prompt-templates/system-design-master-prompt.md`
...
| **E: Reference-Driven** | มี reference website เป็นต้นแบบ visual style | `ux-design-reference-prompt.md` + user-supplied `design-reference/*-DESIGN.md` (acquisition per `.agents/development-guide/ux-design-reference-acquisition.md`) |
...
**Prompt:** `.agents/prompt-templates/technical-design-master-prompt.md`
...
│       ├── web/handoff.md
│       └── worker/handoff.md
├── .agents/development-guide/               ← Step-by-step workflow guides
│   ├── full-journey.md
│   ├── ba-claim-review-workflow.md
│   ├── sd-claim-review-workflow.md
│   ├── td-workflow.md
...
│   └── backtrack-workflow.md
├── services/                        ← Source code (tech stack ตาม CLAUDE.md)
│   ├── api/
│   ├── web/
│   └── worker/
├── .env                             ← Secrets (อยู่ใน .gitignore)
└── methodologies/full-track/constitution/
    └── ai-native-development-runbook.md  ← This file
```

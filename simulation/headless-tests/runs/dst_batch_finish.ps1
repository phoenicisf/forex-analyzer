...
$progress = "$PSScriptRoot\dst_batch_finish_progress.txt"
$root = (Get-Item "$PSScriptRoot\..\..\..").FullName
"DST batch-finish start: $(Get-Date -Format 'yyyy-MM-dd HH:mm:ss')" | Out-File $progress
...
"DST batch-finish complete: $(Get-Date -Format 'yyyy-MM-dd HH:mm:ss')" | Add-Content $progress

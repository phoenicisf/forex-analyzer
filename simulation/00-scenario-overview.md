...
- **Full Track scenarios** → `methodologies/full-track/simulation/` (this folder)
- **Lean Track scenarios** → `methodologies/lean-track/simulation/`

> **Migration note (2026-04):** ไฟล์ทั้งหมดย้ายมาจาก `docs/simulation/` เดิม — `docs/` เป็น project output dir ไม่เหมาะเก็บ methodology docs
